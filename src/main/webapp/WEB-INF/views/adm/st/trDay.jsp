        ...
        <div id="tabs-1" class="topLine">
          ...
          <section id="tab-container" class="stats">
            <ul>
              ...
              <li><a href="javascript:doSubmit('${pageContext.request.contextPath }/adm/st/list?url=trDay', 'command', 'post');" class="tab"><img src="<c:url value='/resources/images/btn_day_on.gif' />" alt="" /></a></li>
            ...
            <section id="contents-2" class="topLine">
              ...
              <div class="statsSchbox">
                <button type="button" class="statsSch" onclick="doSubmit('${pageContext.request.contextPath }/adm/st/list?url=trDay', 'command', 'post')"></button>
              ...
              <section>
                <table class="boardSch" summary="Month">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th><a href="javascript:doSubmit('${pageContext.request.contextPath }/adm/st/list?url=trTime&strDay=${fn:substring(result.END_DAILY,6,8)}', 'command', 'post');">${fn:substring(result.END_DAILY,4,6)}/${fn:substring(result.END_DAILY,6,8)}<em>(${fn:substring(result.DAYNAME,0,3)})</em></a></th>
              ...
              <div class="excelDown unit">
                <div class="alignCenter">
                  <div class="button1 type2">
                    <a href="javascript:doExcelFileDownSubmit('${pageContext.request.contextPath }/adm/st/list?url=trDay&downExcel=Y', 'command', 'post');"><img src="<c:url value='/resources/images/btn_icon_excel.gif' />" alt="icon" /><span>Download Excel</span></a>
                  </div>
                </div>
              </div>
              <!-- Day : end -->
