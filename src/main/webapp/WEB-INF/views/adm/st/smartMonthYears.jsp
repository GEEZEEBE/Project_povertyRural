        ...
        <section id="tabs-2">
          ...
          <dl class="network learning">
            ...
            <dd>
              ...
              <p class="sch">
                <button type="button" onclick="doSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartMonth.years&strNum=${requestMap.strNum}', 'command', 'post');"></button>
              </p>
            </dd>
          </dl>
          <section id="tab-container" class="stats">
            <ul>
              ...
              <li><a href="javascript:doSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartMonth', 'command', 'post');"><img src="<c:url value='/resources/images/btn_back.gif' />" alt="Go Back" /></a></li>
            </ul>
            <section id="tabs2-01">
              <!-- 월별보기 : str -->
          ...
          <div class="excelDown">
            <div class="alignCenter">
              <div class="button1 type2">
                <a href="javascript:doExcelFileDownSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartMonth.years&strNum=${requestMap.strNum}&downExcel=Y', 'command', 'post');"><img src="<c:url value='/resources/images/btn_icon_excel.gif' />" alt="icon" /><span>Dowenload Excel</span></a>
              </div>
            </div>
          </div>
          <!-- Smart Class : end -->
