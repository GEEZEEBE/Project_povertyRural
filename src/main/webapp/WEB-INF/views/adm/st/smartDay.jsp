        ...
        <section id="tabs-2">
          ...
          <dl class="network learning">
            ...
            <dd>
              ...
              <p class="sch">
                <button type="button" onclick="doSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartDay', 'command', 'post');"></button>
              </p>
            </dd>
          </dl>
              ...
              <section class="topLine">
                ...
                <table class="boardSch" summary="search">
                  ...
                  <thead>
                    <tr>
                      <th>Sort</th>
                      <th><a href="javascript:doSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartDay.days&strNum=4', 'command', 'post');">Year4</a></th>
                      <th><a href="javascript:doSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartDay.days&strNum=9', 'command', 'post');">Year5</a></th>
                      <th><a href="javascript:doSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartDay.days&strNum=14', 'command', 'post');">Year6</a></th>
                      <th><a href="javascript:doSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartDay.days&strNum=19', 'command', 'post');">Advanced English</a></th>
          ...
          <div class="excelDown">
            <div class="alignCenter">
              <div class="button1 type2">
                <a href="javascript:doExcelFileDownSubmit('${pageContext.request.contextPath }/adm/st/list?url=smartDay&downExcel=Y', 'command', 'post');"><img src="<c:url value='/resources/images/btn_icon_excel.gif' />" alt="icon" /><span>Dowenload Excel</span></a>
              </div>
            </div>
          </div>
          <!-- Smart Class : end -->
