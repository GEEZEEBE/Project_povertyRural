...
<section class="error">
  ...
  <p>
    <img src="<c:url value='/resources/usr/images/txt_402error1.gif' />" alt="402 Error page not found." />
<!-- 403 / 402 / 401 / 400 error image
 ...
 -->
    <img src="<c:url value='/resources/usr/images/txt_404error2.gif' />" alt="please try this page." />
  </p>
